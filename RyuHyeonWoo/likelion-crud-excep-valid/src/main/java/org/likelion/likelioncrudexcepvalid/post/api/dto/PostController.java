...
public class PostController {
    ...
    @GetMapping("/{postId}")
    @ResponseStatus(HttpStatus.OK)
    public BaseResponse<PostInfoResDto> myPostFindById(@PathVariable("postId") Long postId) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public BaseResponse<PostListResDto> findByWriter(@PathVariable("writer") String writer) {
        PostListResDto postListResDto = postService.findByWriter(writer);
        return BaseResponse.success(SuccessCode.GET_SUCCESS, postListResDto);
    }

...
import org.likelion.likelioncrudexcepvalid.common.exception.CustonException;
...
public class CustomExceptionAdvice {
    ...
    private String convertMapToString(Map<String, String> map){
        ...
        sb.deleteCharAt(sb.length() -1 );//마지막 띄어 쓰기 제거
    ...
    public BaseResponse handlerCustomException(CustonException e) {

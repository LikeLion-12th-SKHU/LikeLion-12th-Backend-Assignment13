...
import static org.likelion.likelioncrudexcepvalid.common.dto.BaseResponse.success;
...
public class MemberController {
    ...
    public BaseResponse<MemberListResDto> memberFindAll(
            ...
            @RequestParam(value = "sort", defaultValue = "memberId,desc")String sort
    ) {
        Pageable pageable;
        ...
        return BaseResponse.success(SuccessCode.MEMBER_SAVE_SUCCESS, memberListResDto);
    }
